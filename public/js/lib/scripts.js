...
!(function (a) {
  "function" == typeof define && define.amd
    ...
    : a(window.jQuery, window.Modernizr);
})(function (a, b, c) {
  "use strict";
  function d(a) {
    return a
    ...
    (t.prototype = {
      ...
      _setVars: function () {
        ...
        (b.$items = b._getItems()),
          ...
          "string" == typeof c
            ? (b.$sizer = b.$el.find(c))
            : c && c.nodeType && 1 === c.nodeType
            ? (b.$sizer = a(c))
            : c && c.jquery && (b.$sizer = c),
          b.$sizer &&
            b.$sizer.length &&
            ((b.useSizer = !0), (b.sizer = b.$sizer[0]));
      },
              ...
              b === o
                ...
                : g.each(function () {
                    var c = a(this),
                      d = c.data(p),
                      f =
                        e.delimeter && !a.isArray(d) ? d.split(e.delimeter) : d;
      ...
      _initItems: function (a) {
        (a = a || this.$items),
          a.css(this.itemCss).data("position", { x: 0, y: 0 });
      },
          ...
          a.each(b, function (b, d) {
            (d.style[g] = "0ms," + (b + 1) * c.sequentialFadeDelay + "ms"),
              a(d).on(i + "." + c.unique, function (b) {
                ...
                d === b.target &&
                  ((d.style[g] = "0ms"), a(d).off(i + "." + c.unique));
              });
          });
      },
      _getItems: function () {
      ...
      _getPreciseDimension: function (b, c) {
        ...
        return (
          (d = window.getComputedStyle
            ? window.getComputedStyle(b, null)[c]
            : a(b).css(c)),
          parseFloat(d)
        );
      },
      ...
      _getColumnSize: function (b, c) {
        ...
        return (
          (d = a.isFunction(this.columnWidth)
            ? this.columnWidth(c)
            : this.useSizer
            ? this._getPreciseDimension(this.sizer, "width")
            : this.columnWidth
            ? this.columnWidth
            : this.$items.length > 0
            ? this._getOuterWidth(this.$items[0], !0)
            : c),
          0 === d && (d = c),
          d + b
        );
      ...
      _getGutterSize: function (b) {
        ...
        return (c = a.isFunction(this.gutterWidth)
          ? this.gutterWidth(b)
          : this.useSizer
          ? this._getPreciseDimension(this.sizer, "marginLeft")
          : this.gutterWidth);
      },
      _setColumns: function (a) {
        var b = a || this._getOuterWidth(this.$el[0]),
          ...
          e = (b + c) / d;
        Math.abs(Math.round(e) - e) < 0.03 && (e = Math.round(e)),
        ...
        (c = c || e._filterEnd),
          a.each(b, function (b, f) {
            ...
            if (
              ...
              d
                ? ((k.skipTransition = !0), (k.opacity = 0))
                : ((k.opacity = 1), (k.callback = c)),
                e.styleQueue.push(k),
      ...
      _reLayout: function () {
        this._resetCols(),
          this.lastSort
            ...
            : this._layout(
                this.$items.filter(".filtered").get(),
                this._filterEnd
              );
      },
      _getItemPosition: function (a) {
        var b = this,
          ...
          d = c / b.colWidth;
        Math.abs(Math.round(d) - d) < 0.03 && (d = Math.round(d));
        ...
        var f,
          ...
          i = [];
        for (g = 0; h > g; g++)
          (f = b.colYs.slice(g, g + e)), (i[g] = Math.max.apply(Math, f));
        return b._placeItem(a, i);
      },
      _placeItem: function (a, b) {
        for (
          var c = this, d = Math.min.apply(Math, b), e = 0, f = 0, g = b.length;
          g > f;
          f++
        )
      ...
      _getStylesForTransition: function (a) {
        ...
        return (
          this.supported
            ? a.x !== c &&
              (b[j] = this._getItemTransformString(a.x, a.y, a.scale))
            : ((b.left = a.x), (b.top = a.y)),
      ...
      _startItemAnimation: function (b, c, d) {
        ...
        this.supported
          ? (b.css(c), this.initialized ? b.on(i + ".shuffleitem", f) : f())
          : ("visibility" in c &&
              (b.css("visibility", c.visibility), delete c.visibility),
      ...
      _handleItemAnimationEnd: function (b, c, d, e) {
        ...
        this._layoutList.length > 0 && a.inArray(c, this._layoutList) > -1
          ? (this._fire(t.EventType.LAYOUT),
            b.call(this),
            (this._layoutList.length = 0))
          : this._shrinkList.length > 0 &&
            a.inArray(c, this._shrinkList) > -1 &&
            (b.call(this), (this._shrinkList.length = 0)),
      ...
      _processStyleQueue: function () {
        ...
        a.each(this.styleQueue, function (a, c) {
          c.skipTransition
            ? b._skipTransition(c.$item[0], function () {
        ...
        ? d.randomize
          ...
          : (d.by !== a.noop &&
              ...
              e.sort(function (b, e) {
                ...
                return g === c && h === c
                  ? ((f = !0), 0)
                  : "sortFirst" === g || "sortLast" === h
                  ? -1
                  : "sortLast" === g || "sortFirst" === h
                  ? 1
                  : h > g
                  ? -1
                  : g > h
